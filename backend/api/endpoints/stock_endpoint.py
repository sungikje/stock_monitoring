...
from backend.services.stock_service import search_company, search_user_favorite_company, create_favorite_company, delete_favorite_company, stock_monitoring
...
async def api_search_user_favorite_company(user: UserSearchUseEmail) -> List[SearchFavoriteCompany]:
