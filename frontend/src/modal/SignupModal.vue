...
<template>
    <div class="modal-overlay" v-if="visible">
      <div class="modal-content">
        <h3>회원가입</h3>
        <input v-model="signupInfo.username" type="text" placeholder="이름 (필수)" />
        <input v-model="signupInfo.email" type="email" placeholder="이메일 (필수)" />
        <input v-model="signupInfo.password" type="password" placeholder="비밀번호 (필수)" />
        <input v-model="signupInfo.phone" type="text" placeholder="전화번호 (선택)" />
